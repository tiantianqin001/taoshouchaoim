...
public class ChatView extends LinearLayout  implements IChatLayout {
    ...
    private void initViews() {
        ...
        mTitleBar.setBackgroundColor(context.getResources().getColor(R.color.white));
        mMessageRecyclerView = findViewById(R.id.chat_message_layout);
        mTitleBar.getUnreadCountTextView().setVisibility(GONE);
        //输入框的view
        ...
        if (isGroup) {
            ...
            getTitleBar().setOnRightClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    imm.showSoftInput(  getTitleBar(),InputMethodManager.SHOW_FORCED);

                    imm.hideSoftInputFromWindow(  getTitleBar().getWindowToken(), 0); //强制隐藏键盘
                }
            });
