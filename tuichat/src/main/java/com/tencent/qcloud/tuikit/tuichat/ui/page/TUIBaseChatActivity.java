...
import com.tencent.qcloud.tuikit.tuichat.util.SoftHideKeyBoardUtil;
...
//                .init();
    ...
    private ChatInfo getChatInfo(Intent intent) {
        ...
        if (chatType == ChatInfo.TYPE_GROUP) {
            ...
            groupInfo.setSilence(intent.getStringExtra(TUIConstants.TUIChat.METHOD_GROUP_SILENCE));
