 ...
 * 自定义键盘
 */
public class CustomerKeyboardRed extends LinearLayout implements View.OnClickListener {
    private int layoutId = R.layout.ui_customer_keyboard_password;
    private CustomerKeyboardClickListener mListener;

    public CustomerKeyboardRed(Context context) {
        this(context, null);
    }

    public CustomerKeyboardRed(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomerKeyboardRed(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, R.layout.ui_customer_keyboard_password, this);
