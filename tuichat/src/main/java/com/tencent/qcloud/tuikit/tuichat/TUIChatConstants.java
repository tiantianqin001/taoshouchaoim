...
public class TUIChatConstants {
    ...
    public static final String USER_TYPING_LOCATION = "user_typing_location";
    public static final String USER_PAYMENT= "Payment";

    public static final String USER_TYPING_RED = "user_red_packet_send";
   // public static final String USER_TYPING_RED_GET = "user_red_packet_send_get";
    public static final String USER_TYPING_RED_GET = "user_red_packet_rob";
    public static final String USER_PERSION_CARD = "business_card_message";
    //再群里发个人名牌你
    public static final String GROUP_PERSION_CADR="group_persion_card";


    public static final String USER_TYPING_TRANSFER = "user_transfer";
    public static final String USER_SYSTEM_NOTICE = "System_Notice";
    public static final String USER_GROUP_NOTICE = "Group_Notice";

    public static final String USER_GROUP_KICKINGE = "group_kicking";
    public static final String USER_GROUP_CREATE= "group_create_custom";
    public static final String USER_GROUP_INVITATION= "group_invitation";
    public static final String USER_GROUP_GROUP_MUTE_ALL= "group_mute_all";
