...
import com.tencent.qcloud.tuikit.tuichat.bean.message.GroupNoticeBean;
...
import com.tencent.qcloud.tuikit.tuichat.bean.message.PaymentMessageBean;
...
import com.tencent.qcloud.tuikit.tuichat.bean.message.SystemAnnouncementBean;
...
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.PersionCardBean;
...
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.GetRedHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.GroopAddHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.GroopCreateHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.GroopKickHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.GroopSystemHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.GroopTabooHolder;
...
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.PaymentMessageHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.PersionCardMessageHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.QuoteMessageHolder;
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.RedEnvelopeMessageHolder;
...
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.SystemAnnouncentHolder;
...
import com.tencent.qcloud.tuikit.tuichat.ui.view.message.viewholder.TransferMessageHolder;
...
public class TUIChatService extends ServiceInitializer implements ITUIChatService {
    ...
    public void init(Context context) {
        ...
        nickName = EncryptUtil.getInstance(getContext()).decrypt(nickName);
    ...
    private void initMessageType() {
        ...
        //定位
        addCustomMessageType(TUIChatConstants.USER_TYPING_LOCATION, LocationMessageBean.class, LocationMessageHolder.class);
        //这个是群红包 也是发红包的界面
        addCustomMessageType(TUIChatConstants.USER_TYPING_RED, RedenvelopeBean.class, RedEnvelopeMessageHolder.class);
        //转账
        addCustomMessageType(TUIChatConstants.USER_TYPING_TRANSFER, StartTransferBean.class, TransferMessageHolder.class);
        //领取了红包的自定义view
        addCustomMessageType(TUIChatConstants.USER_TYPING_RED_GET, GetReadBean.class, GetRedHolder.class);
        //交易助手
        addCustomMessageType(TUIChatConstants.USER_PAYMENT, PaymentMessageBean.class, PaymentMessageHolder.class);
        //系统公告
        addCustomMessageType(TUIChatConstants.USER_SYSTEM_NOTICE, SystemAnnouncementBean.class, SystemAnnouncentHolder.class);
        //群踢人
        addCustomMessageType(TUIChatConstants.USER_GROUP_KICKINGE, GroupkickBean.class, GroopKickHolder.class);
        //群通知
        addCustomMessageType(TUIChatConstants.USER_GROUP_NOTICE, GroupNoticeBean.class, GroopSystemHolder.class);

        //建群成功
        addCustomMessageType(TUIChatConstants.USER_GROUP_CREATE, GroupCreateBean.class, GroopCreateHolder.class);
        //拉人进群
        addCustomMessageType(TUIChatConstants.USER_GROUP_INVITATION, GroupAddBean.class, GroopAddHolder.class);
        //群禁言
        addCustomMessageType(TUIChatConstants.USER_GROUP_GROUP_MUTE_ALL, GroupTabooBean.class, GroopTabooHolder.class);
        //个人名片
        addCustomMessageType(TUIChatConstants.USER_PERSION_CARD, PersionerCardBean.class, PersionCardMessageHolder.class);
...
//                                            TUIGroupLog.i(TAG, "modifyGroupInfo failed type| value| code| desc " );
//
//                                        }
//
//                                        @Override
//                                        public void onSuccess() {
//                                            TUIGroupLog.i(TAG, "modifyGroupInfo onSuccess type| value| code| desc " );
//                                        }
//                                    });
                                }
