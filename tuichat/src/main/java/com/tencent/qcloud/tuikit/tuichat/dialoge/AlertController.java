package com.tencent.qcloud.tuikit.tuichat.dialoge;
...
public class AlertController {
    ...
    public static class AlertParams {
        ...
        public void fromBottomToMiddle() {
            mWindowAnimations = R.style.main_menu_anim_style;
        ...
        public void loadAnimation() {
            mWindowAnimations = R.style.dialog_scale_anim_style;
        }

        public void loadAnimation(int styleId) {
            mWindowAnimations = styleId;
        }
