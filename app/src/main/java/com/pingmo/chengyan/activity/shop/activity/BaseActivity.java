...
import com.pingmo.chengyan.activity.shop.dialog.LoadingDialog;
import com.pingmo.chengyan.activity.shop.utils.PermissionCheckUtil;
...
//        StatusBarUtil.setStatusBarColor(this, getResources().getColor(R.color.white)); //Color.parseColor("#F5F6F9")
    ...
    private void registerLogoutBoardcast() {
        IntentFilter intentFilter = new IntentFilter("com.rong.webar.action.logout");
    ...
    public void sendLogoutNotify() {
        //发送广播
        Intent intent = new Intent("com.rong.webar.action.logout");
