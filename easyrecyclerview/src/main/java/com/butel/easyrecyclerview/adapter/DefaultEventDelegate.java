...
import com.butel.easyrecyclerview.R;
...
public class DefaultEventDelegate implements EventDelegate {
    ...
    @Override
    public void pauseLoadMore(String msg) {
        log("pauseLoadMore");
    ...
    @Override
    public void setEnableShow(boolean enable) {
        ...
        public View refreshStatus(ViewGroup parent) {
            ...
            switch (flag) {
                ...
                case ShowError:
                    ...
                    if (!TextUtils.isEmpty(errorMsg) && view != null && view.findViewById(R.id.load_error_msg) != null) {
                        TextView textView = view.findViewById(R.id.load_error_msg);
