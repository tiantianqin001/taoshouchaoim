    ...
    public void loadGroupInfo(final String groupId, int filter, final IUIKitCallback<GroupInfo> callBack) {
        ...
        loadGroupPublicInfo(groupId, new IUIKitCallback<V2TIMGroupInfoResult>() {
            ...
            public void onSuccess(V2TIMGroupInfoResult data) {
                ...
                sp =  TUILogin.getAppContext().getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
                String token = sp.getString("token", "");

                token = EncryptUtil.getInstance(TUILogin.getAppContext()).decrypt(token);
                //获取群消息
                    ...
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                        ...
                        try {
                            ...
                            if (code == 200){
                                ...
                                //设置群主
                                String createId = optJSONObject.optString("createId");
                                groupInfo.covertTIMGroupDetailInfo(data,createId);
                            ...
                            if (code == 403){
                                ...
                                TUILogin.getAppContext(). sendBroadcast(intent);
                            }
