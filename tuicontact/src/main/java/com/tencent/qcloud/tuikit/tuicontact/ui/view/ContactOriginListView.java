...
public class ContactOriginListView extends LinearLayout implements IContactListView {

    private static final String TAG = ContactOriginListView.class.getSimpleName();

    private static final String INDEX_STRING_TOP = "↑";
    private RecyclerView mRv;
    private ContactOriginAdapter mAdapter;
    ...
    public ContactOriginListView(Context context) {
        super(context);
        init();
    }

    public ContactOriginListView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ContactOriginListView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mAdapter = new ContactOriginAdapter(getContext(),mData);
    ...
    public ContactOriginAdapter getAdapter() {
        return mAdapter;
    }
    ...
    public void loadDataSource(int dataSource) {
        ...
        if (dataSource == ContactOriginListView.DataSource.GROUP_MEMBER_LIST) {
            presenter.loadGroupMemberList(groupId);
        } else {
