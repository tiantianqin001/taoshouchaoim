            ...
            if (isAccept) {
                ...
                presenter.acceptFriendApplication(bean, new IUIKitCallback<Void>() {
                    ...
                    public void onSuccess(Void data) {
                        ...
                        V2TIMMessage v2TIMMessage = V2TIMManager.getMessageManager().createTextMessage("我们已经是好友啦");
                        V2TIMManager.getMessageManager().sendMessage(v2TIMMessage, userId,
                                null, V2TIMMessage.V2TIM_PRIORITY_NORMAL,
                                false, null, new V2TIMSendCallback<V2TIMMessage>() {
                                    @Override
                                    ...
                                    public void onSuccess(V2TIMMessage v2TIMMessage) {
                                        Log.i(TAG, "onSuccess: "+v2TIMMessage);
