...
public class ContactOriginAdapter extends RecyclerView.Adapter<ContactOriginAdapter.ViewHolder> {

    private Context context;
    protected List<ContactItemBean> mData;
    private ContactOriginListView.OnSelectChangedListener mOnSelectChangedListener;
    private ContactOriginListView.OnItemClickListener mOnClickListener;
    ...
    private int dataSourceType = ContactOriginListView.DataSource.UNKNOWN;

    private int chartType  = 0;
    private boolean isFistLoad = true;


    public ContactOriginAdapter(Context context, List<ContactItemBean> data) {
    ...
    @Override
    public ContactOriginAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ContactOriginAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.contact_selecable_adapter_item, parent, false));
    }

    @Override
    public void onBindViewHolder(final ContactOriginAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
...
//        }
    ...
    @Override
    public void onViewRecycled(ContactOriginAdapter.ViewHolder holder) {
        if (holder != null) {
    ...
    public void setOnSelectChangedListener(ContactOriginListView.OnSelectChangedListener selectListener) {
        mOnSelectChangedListener = selectListener;
    }

    public void setOnItemClickListener(ContactOriginListView.OnItemClickListener listener) {
