...
public class PersionCustomerListView extends LinearLayout implements IContactListView {

    private static final String TAG = PersionCustomerListView.class.getSimpleName();

    private static final String INDEX_STRING_TOP = "↑";
    private RecyclerView mRv;
    private PersionCustomerAdapter mAdapter;
    ...
    public PersionCustomerListView(Context context) {
        super(context);
        init();
    }

    public PersionCustomerListView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PersionCustomerListView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mAdapter = new PersionCustomerAdapter(getContext(),mData);
    ...
    public PersionCustomerAdapter getAdapter() {
        return mAdapter;
    }
    ...
    public void loadDataSource(int dataSource) {
        ...
        if (dataSource == PersionCustomerListView.DataSource.GROUP_MEMBER_LIST) {
            presenter.loadGroupMemberList(groupId);
        } else {
