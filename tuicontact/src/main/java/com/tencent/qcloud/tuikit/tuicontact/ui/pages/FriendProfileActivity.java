...
public class FriendProfileActivity extends BaseLightActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        int groupMemberProtect = intent.getIntExtra("groupMemberProtect", 0);
        layout.setIsGroup(isGroup);
        layout.setAdmin(isAdmin);
        layout.setGroupMemberProtect(groupMemberProtect);
