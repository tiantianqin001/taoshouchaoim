...
public class GlideEngine implements ImageEngine {
    ...
    public static void loadCornerImageWithoutPlaceHolder(ImageView imageView, Bitmap filePath, RequestListener listener, float radius) {
        CornerTransform transform = new CornerTransform(TUILogin.getAppContext(), radius);
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .transform(transform);
    ...
    public static void loadImage(ImageView imageView, String filePath) {
        Glide.with(TUILogin.getAppContext())
                ...
                .load(filePath)
                .error(TUILogin.getAppContext().getResources()
                        .getDrawable(R.drawable.core_default_user_icon_serious))
              //  .apply(new RequestOptions().error(TUIThemeManager.getAttrResId(TUILogin.getAppContext(), R.attr.core_default_user_icon)))
                .into(imageView);
    }
    ...
    public static void loadImage(ImageView imageView, Uri uri) {
        ...
        Glide.with(TUILogin.getAppContext())
                .load(uri)
                .placeholder(TUIThemeManager.getAttrResId(TUILogin.getAppContext(), R.drawable.core_default_user_icon_serious))
                .error(TUILogin.getAppContext().getDrawable( R.drawable.core_default_user_icon_serious))
...
//                    .into(imageView);
    ...
    public static void loadUserIcon1(ImageView imageView, File uri, int defaultResId, int radius) {
        Glide.with(TUILogin.getAppContext())
                .load(uri)
                .placeholder(defaultResId)
                .apply(RequestOptions.bitmapTransform(new CircleCrop()))
