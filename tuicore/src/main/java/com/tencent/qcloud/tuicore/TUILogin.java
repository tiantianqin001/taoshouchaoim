...
public class TUILogin {
    ...
    public static void setUserInfo(String userId,String nickname,String headImage) {
        ...
        V2TIMManager.getInstance().getUsersInfo(userIdList, new V2TIMValueCallback<List<V2TIMUserFullInfo>>() {
            ...
            public void onSuccess(List<V2TIMUserFullInfo> v2TIMUserFullInfos) {
                ...
                userFullInfo.setFaceUrl(headImage);
    ...
    public static void updateProfile(int type) {
        V2TIMUserFullInfo v2TIMUserFullInfo = new V2TIMUserFullInfo();

        // 加我验证方式
        v2TIMUserFullInfo.setAllowType(type);
