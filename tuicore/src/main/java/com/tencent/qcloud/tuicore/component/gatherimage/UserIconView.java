...
public class UserIconView extends RelativeLayout {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        iv_group_logo = findViewById(R.id.iv_group_logo);
    ...
    public void setLogo(int type){
        //type  1 是群主  2 是管理员
        iv_group_logo.setVisibility(VISIBLE);
        if (type == 1){
            iv_group_logo.setBackground(getContext().getResources()
                    .getDrawable(R.drawable.group_admin));
        }else if (type == 2){
            iv_group_logo.setBackground(getContext().getResources()
                    .getDrawable(R.drawable.group_manage));
        }else {
            iv_group_logo.setVisibility(GONE);
        }
    }
